...
<div id="copy"><a href="https://twitter.com/igcorreia" target="_blank"><br/>Opulentia Cresco Private</a></div>
<div className="mask" >
   ...
   <div className="circle" ><img src={logo} style={{height:"120px",width:"120px",backgroundColor:"white",borderRadius:"100px"}}/></div>
    <div className="login" style={{marginTop:"0rem"}}>
      ...
      <form method="post">
        ...
        <button disabled={signup_password == signup_password_conf ? false : true} className="btn btn-primary btn-block btn-large" type="submit" onClick={()=>{
        ...
        <a style={{fontSize:"10px",color:"white",textDecoration:"none",textAlign:"center",alignContent:"center",marginLeft:"4rem",marginTop:"2rem",cursor:"pointer"}} onClick={()=>{
            ...
            Already Registered? Sigin Here
            </a>
      </form>
    </div>
  </div> :
    <div className="modal1" style={{zIndex:10}}>
    <div className="circle" ><img src={logo} style={{height:"120px",width:"120px",backgroundColor:"white",borderRadius:"100px"}}/></div>
    <div className="login">
      <h1>Login</h1>
        ...
        <button className="btn btn-primary btn-block btn-large" type="submit" onClick={()=>{
          axios({
        ...
        <a style={{fontSize:"10px",color:"white",textDecoration:"none",textAlign:"center",alignContent:"center",marginLeft:"4rem",marginTop:"2rem",cursor:"pointer"}} onClick={()=>{
            setsignup(true)
        }}>Dont have Account? Singup here</a>
